...
#define FUTUREPIA_INIT_PRIVATE_KEY                                (fc::ecc::private_key::regenerate(fc::sha256::hash(std::string("fiberchain"))))
...
#define FUTUREPIA_CHAIN_ID                                        (fc::sha256::hash("fiberchain_testnet"))
