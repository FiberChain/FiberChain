...
#include <futurepia/chain/hardfork_property_object.hpp>
#include <futurepia/chain/node_property_object.hpp>
...
namespace futurepia { namespace chain {
   ...
   protected:
      ...
      private:
         ...
         void apply_operation( const operation& op, const signed_transaction& trx );
