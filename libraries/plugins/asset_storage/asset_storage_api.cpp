...
namespace futurepia { namespace asset_storage {
   ...
   namespace detail {
      class asset_api_impl
      {
         public:
            ...
            optional< asset_storage_api_object > get_asset_by_name( string asset_name ) const;
      ...
      optional< asset_storage_api_object > asset_api_impl::get_asset_by_name( string asset_name ) const
      {
      ...
      vector< asset_storage_api_object > asset_api_impl::get_assets_by_owner( string& owner ) const
      {
   ...
   optional< asset_storage_api_object > asset_api::get_asset_by_name( string asset_name ) const
   {
   ...
   vector< asset_storage_api_object > asset_api::get_assets_by_owner( string owner ) const
   {
      return _my->database().with_read_lock( [ & ]()
      {
